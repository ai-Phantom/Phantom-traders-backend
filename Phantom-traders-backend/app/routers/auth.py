...
async def signup(req: SignupRequest):
    ...
    # 2. Upsert user profile row (free plan by default)
    # Using upsert so re-signups don't cause 400 errors
    ...
    # 3. Send welcome email (non-blocking — failure won't break signup)
    try:
